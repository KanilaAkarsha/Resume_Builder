  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto py-8 px-4">
        ...
        <hr className="border-slate-300 border-dashed my-6 sm:w-[305px]" />
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              <button
                ...
                className="relative w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 group hover:shadow-lg transition-all duration-300 border cursor-pointer"
                style={{
                ...
                <div
                  ...
                  className="absolute top-1 right-1 group-hover:flex  items-center gap-1 hidden ">
                  <TrashIcon

...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async (index) => {
    ...
    const prompt = `Generate a concise and impactful job description for a resume based on the following details: Company: ${exp.company}, Position: ${exp.position}, Start Date: ${exp.start_date}, End Date: ${exp.end_date}, Currently Working: ${exp.is_current}. Focus on key responsibilities and achievements.`;

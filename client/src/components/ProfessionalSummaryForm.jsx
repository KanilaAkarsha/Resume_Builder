...
const ProfessionalSummaryForm = ({ data, onChange, setResumeData }) => {
  ...
  const generateSummary = async () => {
    ...
    try {
      const prompt = `enhance the following professional summary for a resume: ${data}`;
    ...
    <div className="space-y-4">
      ...
      <div className="mt-6">
        <textarea
          ...
          className="w-full p-3 px-4 mt-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-sm resize-none"
        />
